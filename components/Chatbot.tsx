...
export default function Chatbot() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Mettre à jour la langue détectée si elle est présente dans la réponse
      if (data.detectedLanguage) {
        setDetectedLanguage(data.detectedLanguage as Language)
      }
      ...
      <div className="bg-gradient-to-r from-purple-600 to-emerald-600 p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="bg-blue-500/30 rounded-lg px-3 py-1 text-white text-xs font-medium">
              🌐 {detectedLanguage === 'fr' ? '🇫🇷 FR' : detectedLanguage === 'pt' ? '🇵🇹 PT' : '🇬🇧 EN'}
            </div>
